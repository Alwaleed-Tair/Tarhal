...
| **8/9** | Send the ERD to Mohamed for review, then translate it into a `schema.prisma` file: define each entity's fields (e.g., Flight: id, flightNumber, from, to, departureTime, basePrice; Seat: id, seatCode, ticketClass, isBooked) | A `schema.prisma` file with all 5 entities and their fields defined |
...
| **12/9** | Attend the review meeting; if anyone questions the data model, be ready to explain or adjust a field on the spot | Participated, and applied any agreed schema wording changes |
...
| **12/9** | Attend the review meeting; be ready to justify the seed-data decision if questioned | Participated, applied any agreed wording changes |
...
| **12/9** | Attend the review meeting; be ready to explain what the AI can and can't reliably do yet | Participated, applied any agreed wording changes |
...
| **12/9** | Attend the review meeting | Participated, applied any agreed wording changes |
